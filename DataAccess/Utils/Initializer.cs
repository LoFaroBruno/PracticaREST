...
namespace DataAccess.Utils
{
    static class Initializer
    {
        public static List<Employee_GeocodingInfo> SeedEmployees()
        {
            ...
            {
                new Employee_GeocodingInfo{  BirthDate = new DateTime(1960, 7, 24), Document=40113322,
                ...
                new Employee_GeocodingInfo{  BirthDate = new DateTime(2002, 5, 20), Document=40224433,
                ...
                new Employee_GeocodingInfo{  BirthDate = new DateTime(2020, 1, 1), Document=40335544,
                    FirstName="TARS", LastName="TARS", Mail="tars@gmail.com",
                    ConfirmMail = "tars@gmail.com", City = "Buenos Aires", Address="Paraguay 2155" },
                new Employee_GeocodingInfo{  BirthDate = new DateTime(1962, 2, 3), Document=40446655,
